### Реализованная функция _calculateLeaderboardPlaces_ находится внутри файла index.js, для удобства проверки было добавлено несколько дополнительных тест-кейсов
